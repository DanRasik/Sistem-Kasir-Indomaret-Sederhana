...
Proyek Ujian Akhir Semester <i>Sistem Basis Data</i>  </p>
...
### 📝 Cara Menjalankan
1. Pastikan MySQL Server atau XAMPP (Apache & MySQL) dalam keadaan aktif.
2. Clone repositori ini atau salin skrip SQL yang tersedia.
3. Eksekusi perintah CREATE DATABASE kasir_indomaret;.
4. Jalankan perintah USE kasir_indomaret;.
5. Impor struktur tabel dan data dari file .sql yang telah disediakan di folder repositori.
